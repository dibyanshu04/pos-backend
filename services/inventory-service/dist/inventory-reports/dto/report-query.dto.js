...
class ReportQueryDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { outletId: { required: true, type: () => String }, from: { required: false, type: () => String }, to: { required: false, type: () => String } };
    }
}
exports.ReportQueryDto = ReportQueryDto;
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Outlet ID (scope for reports)', example: 'outlet-123' }),
